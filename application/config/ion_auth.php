...
*/
$config['tables']['pengguna']           = 'pengguna'; /* pengguna / users */
$config['tables']['grup']          = 'grup'; /* grup / groups */
$config['tables']['grup_pengguna']    = 'grup_pengguna'; /* grup_pengguna / users_groups */
 ...
 */
$config['join']['pengguna']  = 'pengguna_id';
$config['join']['grup'] = 'grup_id';
 ...
 */
$config['remember_cookie_name'] = 'remember_kode';
